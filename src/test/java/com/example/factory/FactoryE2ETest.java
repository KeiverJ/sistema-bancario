...
class FactoryE2ETest {
    ...
    void e2e_abrirCredito_viaFabrica() {
        ...
        var credito = ctx.creditoService.solicitarCredito(c.getId(), com.example.model.Credito.TipoCredito.CONSUMO, 50_000, 24);
        assertNotNull(credito.getId());
        assertEquals(com.example.model.Credito.TipoCredito.CONSUMO, credito.getTipoCredito());
    ...
    void e2e_depositoYPagoServicio() {
        ...
        assertEquals(com.example.model.Transaccion.TipoTransaccion.DEPOSITO, dep.getTipo());
        ...
        assertEquals(com.example.model.Transaccion.TipoTransaccion.PAGO_SERVICIO, pago.getTipo());
