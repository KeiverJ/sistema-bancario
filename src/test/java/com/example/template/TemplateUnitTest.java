...
class TemplateUnitTest {
    ...
    void flujoExitosoSolicitud() {
        ...
        var builder = org.mockito.Mockito.mock(com.example.builder.credito.CreditoBuilder.class);
        ...
        org.mockito.Mockito.when(builder.desdeBase(org.mockito.Mockito.any())).thenReturn(builder);
                org.mockito.Mockito.when(builder.build()).thenAnswer(inv -> {
                        com.example.model.credito.Credito c = new com.example.model.credito.Credito();
                        c.setTipoCredito(com.example.model.credito.Credito.TipoCredito.LIBRE_INVERSION);
                        c.setMonto(10000);
                        c.setPlazoMeses(12);
                        return c;
                });
        var strategyRegistry = org.mockito.Mockito.mock(com.example.strategy.core.InteresStrategyRegistry.class);
        ...
        var chainBuilder = org.mockito.Mockito.mock(com.example.chain.core.ApprovalChainBuilder.class);
        var chain = org.mockito.Mockito.mock(com.example.chain.core.ApprovalHandler.class);
        org.mockito.Mockito.when(chainBuilder.build(org.mockito.Mockito.any())).thenReturn(chain);
                org.mockito.Mockito.doAnswer(inv -> {
                        ((com.example.chain.core.ApprovalContext) inv.getArgument(0)).aprobar();
                        return null;
                }).when(chain).handle(org.mockito.Mockito.any());
        var creditoRepo = org.mockito.Mockito.mock(com.example.repository.credito.CreditoRepository.class);
        org.mockito.Mockito.when(creditoRepo.save(org.mockito.Mockito.any())).thenAnswer(inv -> inv.getArgument(0));
        var clienteRepo = org.mockito.Mockito.mock(com.example.repository.cliente.ClienteRepository.class);
        org.mockito.Mockito.when(clienteRepo.save(org.mockito.Mockito.any())).thenAnswer(inv -> inv.getArgument(0));
        var publisher = org.mockito.Mockito.mock(com.example.observer.core.DomainEventPublisher.class);
        var scoreRegistry = org.mockito.Mockito.mock(com.example.adapter.score.ScoreProviderRegistry.class);
        org.mockito.Mockito.when(scoreRegistry.obtenerScoreParaCliente(org.mockito.Mockito.any()))
                .thenReturn(new com.example.model.score.Score());
        ...
        var template = new com.example.template.impl.SolicitudCreditoDefault(
                ...
                bankConfig);
        var cliente = org.mockito.Mockito.mock(com.example.model.cliente.Cliente.class);
        org.mockito.Mockito.when(cliente.getId()).thenReturn("cli1");
        org.mockito.Mockito.when(cliente.getTipoCliente())
                .thenReturn(com.example.model.cliente.Cliente.TipoCliente.PERSONA_NATURAL);
        var credito = template.solicitar(cliente, com.example.model.credito.Credito.TipoCredito.LIBRE_INVERSION, 10000, 12);
    ...
    void solicitudMontoInvalido() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> template.solicitar(cliente, com.example.model.credito.Credito.TipoCredito.LIBRE_INVERSION, 0, 12));
    }
    ...
    void solicitudPlazoInvalido() {
        ...
        var cliente = org.mockito.Mockito.mock(com.example.model.cliente.Cliente.class);
        assertThrows(IllegalArgumentException.class,
                () -> template.solicitar(cliente, com.example.model.credito.Credito.TipoCredito.LIBRE_INVERSION, 10000, 0));
    }
    ...
    void solicitudRechazada() {
        ...
        org.mockito.Mockito.when(chainBuilder.build(org.mockito.Mockito.any())).thenReturn(chain);
                org.mockito.Mockito.doAnswer(inv -> {
                        ((com.example.chain.core.ApprovalContext) inv.getArgument(0)).rechazar("NO");
                        return null;
                }).when(chain).handle(org.mockito.Mockito.any());
        var creditoRepo = org.mockito.Mockito.mock(com.example.repository.credito.CreditoRepository.class);
        org.mockito.Mockito.when(creditoRepo.save(org.mockito.Mockito.any())).thenAnswer(inv -> inv.getArgument(0));
        ...
        assertThrows(IllegalStateException.class,
                () -> template.solicitar(cliente, com.example.model.credito.Credito.TipoCredito.LIBRE_INVERSION, 10000, 12));
    }
}
