...
public class FactoryExtranjero implements ProductoBancarioFactory {

    private static final AtomicInteger contadorCuenta = new AtomicInteger(3001);
    private static final AtomicInteger contadorCredito = new AtomicInteger(3001);
    private static final AtomicLong contadorNumeroCuenta = new AtomicLong(3000000000L);
